#Olá! Essa é a edição PC do app_fii
#Essa edição contém uma gui amigável ao usuário fácil de usar.
#
#OBS: Dentro do próprio auto_fii existe uma seção 'Instruções', portanto a única nota que vou fazer aqui é que, quando você ativar o #script pela primeira vez, provavelmente vai notar 2 coisas:
